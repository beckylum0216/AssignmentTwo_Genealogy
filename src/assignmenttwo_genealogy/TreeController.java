...
//        HashMap<String, Integer> nodeLevel = new HashMap<>();
//        
//        Nodi rootNode = this.appController.GetTreeDB().GetRootNode();
//        Leaf root = new Leaf(rootNode)
//        LeafView rootView = new LeafView(root);
//        
...
//    {
//        ArrayList <LeafView> sourceList = this.familyTree.get(targetNode.GetNodeID());
//        for(int ii = 0; ii < sourceList.size(); ii += 1)
//        {
//            if(sourceList.get(ii).GetNodeID() == targetNode.GetNodeID())
//            {
//                return ii;
//            }
//        }
